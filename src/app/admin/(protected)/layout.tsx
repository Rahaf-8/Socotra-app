    ...
    <aside className="border-b bg-charcoal px-5 py-5 text-white lg:min-h-screen lg:border-b-0 lg:border-e lg:px-6 lg:py-8">
      ...
      <nav aria-label="Administrator" className="mt-5 lg:mt-10">
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:block lg:space-y-2">
          ...
          <Link href="/admin/booking-requests" className="block rounded-xl px-4 py-3 font-semibold transition hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Booking Requests</Link>
          <Link href="/admin/contact-requests" className="block rounded-xl px-4 py-3 font-semibold transition hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Contact Requests</Link>
          <Link href="/admin/reviews" className="block rounded-xl px-4 py-3 font-semibold transition hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Reviews</Link>
          ...
          <Link href="/admin/faq" className="block rounded-xl px-4 py-3 font-semibold transition hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">FAQ</Link>
          <Link href="/admin/about" className="block rounded-xl px-4 py-3 font-semibold transition hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">About</Link>
          <Link href="/admin/contact" className="block rounded-xl px-4 py-3 font-semibold transition hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Contact Content</Link>
          <Link href="/admin/gallery" className="block rounded-xl px-4 py-3 font-semibold transition hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Gallery</Link>
        </div>
      </nav>
