...
export function getHomeContent(locale: Locale, whatsappUrl: string): HomeContent {
  ...
  return {
    ...
    gallery: {
      ...
      description: ar ? "استكشف لمحة بصرية عن مناظر سقطرى المتنوعة وشواطئها الهادئة وجبالها وحياتها البرية وبيئتها الطبيعية المميزة." : "Explore a visual preview of Socotra’s varied landscapes, quiet beaches, mountain scenery, wildlife, and distinctive natural surroundings.",
